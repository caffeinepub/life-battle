  ...
  return (
    <div
      className={cn(
        ...
        match.status === MatchStatus.ongoing && "border-green-500/30",
    ...
    >
      ...
      <div className="flex items-center justify-between mb-3">
        ...
        <div className="flex items-center gap-1.5">
          <span className="text-[10px] font-mono px-1.5 py-0.5 rounded-full border border-primary/30 bg-primary/10 text-primary">
